...
public interface IUserInterface
{
    ...
    T Select<T>(string prompt, IEnumerable<T> choices, Func<T, string> displayConverter);
    List<T> MultiSelect<T>(string prompt, IEnumerable<T> choices, Func<T, string> displayConverter);
