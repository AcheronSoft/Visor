...
public class CodeEmitter(string toolVersion)
{
    ...
    {
        var stringBuilder = new StringBuilder();
        // Naming convention: {ProcedureName}Result
    ...
    private void EmitProperty(StringBuilder stringBuilder, ColumnDefinition columnDefinition)
    {
        ...
        // We explicitly map the Name property to handle mismatch between DB naming and C# naming conventions
    ...
    // --- Naming Normalization Helpers (Now Public Static) ---
    ...
    public static string NormalizeMethodName(string databaseName)
    {
        ...
        return string.Join("", cleanParts.Select(ToPascalCase));
    }
    
    public static string NormalizeClassName(string databaseName) => NormalizeMethodName(databaseName);
    
    public static string NormalizePropertyName(string databaseName) => ToPascalCase(databaseName);
